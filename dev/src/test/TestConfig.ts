...
namespace TestConfig {
    ...
    const testableProjectTypes: ITestableProjectType[] = [
        ...
        {
            projectType: new ProjectType(ProjectType.InternalTypes.APPSODY, ProjectType.Languages.NODE),
            canRestart: true,
        ...
        {
            projectType: new ProjectType(ProjectType.InternalTypes.APPSODY, ProjectType.Languages.JAVA),
            canRestart: true,
        ...
        {
            projectType: new ProjectType(ProjectType.InternalTypes.APPSODY, ProjectType.Languages.PYTHON),
            canRestart: false,
