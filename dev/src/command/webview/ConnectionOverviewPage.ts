...
export default function getConnectionInfoPage(connectionInfo: IRemoteCodewindInfo): string {
            ...
            <div id="deployment-box">
                ...
                <div class="input">
                    ...
                    `<input type="text" id="ingress-url" class="input-url" name="ingress-url" 
                        placeholder="${connectionInfo.url ? "" : "codewind-workspace-mycluster.nip.io"}"
                    ...
                    <div style="float: left; margin-top: 10px;">
                        ...
                        value="${connectionInfo.username ? connectionInfo.username : ""}"
                        />`}
                    </div>
    ...
    <script>
        ...
        function submitNewConnection() {
            ...
            sendMsg("${ConnectionOverviewWVMessages.SAVE_CONNECTION_INFO}", { ingressUrl: ingressInput.value,  username: ingressUsername.value, password: ingressPassword.value, label: clabel.value });
        }
        ...
        function testNewDockerRegistry() {
            ...
            sendMsg("${ConnectionOverviewWVMessages.SAVE_REGISTRY}", { registryUrl: dockerRegistryURL.value,  registryUsername: dockerRegistryUsername.value, registryPassword: dockerRegistryPassword.value });
        }
